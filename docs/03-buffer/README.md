...
2. [3.2 Buffer Pressure & Pruning](./3.2-buffer-pressure-and-pruning.md) — the 30-day retention windows, the 50 / 45 GiB soft-pause hysteresis, when pruning runs, and how `BUFFER_FULL` is set and cleared.
